 ...
 * fw.hashVal(l,r) will return [l,,r] merged double hash value(inclusive)
 * fw.hashOne(l, r) will return [l,,r] base1 hash(inclusive)
 * fw.hashTwo(l, r) will return [l,,r] base2 hash(inclusive)
*/
